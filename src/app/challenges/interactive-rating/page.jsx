...
export default function rating() {
  ...
  return (
    <main className="flex bg-rating-very-dark-blue min-w-full min-h-screen justify-center items-center">
      <BackV2
        fem={
          "https://www.frontendmentor.io/solutions/interactive-rating-with-framer-motion-animations-cTYntoc2IF"
        }
        git={
          "https://github.com/joshpickardme/frontend-mentor/tree/main/src/app/challenges/interactive-rating"
        }
        white={true}></BackV2>
      {howActive && (
        <HowCard
          ...
          setHowActive={setHowActive}
        />
      )}
      {!howActive && <ThanksCard scoreActive={scoreActive} />}
    </main>
  );
}
