    ...
    return (
        <div className="flex flex-col gap-8">
            <div className="flex flex-col lg:flex-row gap-[18px]">
                <Plan icon={'/multi-step-form/icon-arcade.svg'} title={'Arcade'} price={duration == 'Monthly' ? '$9/mo' : '$90/yr'}></Plan>
                <Plan icon={'/multi-step-form/icon-advanced.svg'} title={'Advanced'} price={duration == 'Monthly' ? '$12/mo' : '$120/yr'}></Plan>
                <Plan icon={'/multi-step-form/icon-pro.svg'} title={'Pro'} price={duration == 'Monthly' ? '$15/mo' : '$150/yr'}></Plan>
            </div>
