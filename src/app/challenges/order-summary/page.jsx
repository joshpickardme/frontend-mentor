...
export default function order() {
    return (
        ...
        <main className="flex  bg-order-pale-blue  min-w-full min-h-screen justify-center items-center">
            <BackV2 fem={'https://www.frontendmentor.io/solutions/order-summary-component-with-entrance-antimation-r6nDsskZ6v'} git={"https://github.com/joshpickardme/frontend-mentor/tree/main/src/app/challenges/order-summary"}></BackV2>
            <Card></Card>
        </main>
        </>
