...
export default function ProductPreviewCard() {
  return (
    <>
      <BackV2
        fem={
          "https://www.frontendmentor.io/solutions/product-preview-card-with-tailwindcss-iBNATvVhHo"
        }
        git={
          "https://github.com/joshpickardme/frontend-mentor/tree/main/src/app/challenges/product-preview-card"
        }></BackV2>
      <main className="flex min-h-screen bg-ppc-cream justify-center items-center">
        <div className="flex flex-col md:flex-row bg-white w-[343px] h-[611px] md:w-[600px] md:h-[450px] rounded-[10px]">
          ...
          <div className="flex flex-col p-6 md:p-8 w-full gap-5">
            ...
            <button className="flex flex-row items-center justify-center rounded-[8px] gap-3 bg-ppc-deep-aquamarine hover:bg-ppc-deep-aquamarine-hover transition-colors duration-150 text-white font-montserrat font-bold text-[14px] py-3 md:mt-4">
              <Image
                className="w-[14] h-[16px]"
