...
export default function SocialLinks() {
  return (
    <>
      <BackV2
        fem={"https://www.frontendmentor.io/solutions/social-links-V-eaR1IxoJ"}
        git={
          "https://github.com/joshpickardme/frontend-mentor/tree/main/src/app/challenges/social-links"
        }
        white={true}></BackV2>
      <main className="flex bg-sociallinks-black  min-w-full min-h-screen justify-center items-center">
        <div className="flex flex-col gap-6 items-center bg-sociallinks-dark-grey w-[384px] h-[611px] rounded-[12px] shadow-lg p-10">
          ...
          <div className="flex flex-col gap-2 items-center">
            ...
            <h2 className=" text-sociallinks-neon-green font-bold text-[14px]">
              London, United Kingdom
            </h2>
          </div>
          <p className="text-sociallinks-white">
            "Front-end developer and avid reader."
          </p>
          <div className="flex gap-3 flex-col">
            {data.map((d) => (
              <SocialButton name={d.name} url={d.url} />
            ))}
          </div>
        </div>
      </main>
