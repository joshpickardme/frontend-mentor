  ...
  return (
    <main className="flex flex-col w-max ml-auto mr-auto pt-6 pb-6 items-center">
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3  auto-rows-auto gap-4 xl:gap-8">
        ...
        <Challenge title={'Interactive Rating'} link={'/challenges/interactive-rating'} languages={['HTML', 'CSS']} difficulty={1} image={'/interactive-rating/desktop-preview.jpg'} description={'This is a nice, small project to practice handling user interactions and updating the DOM. Perfect for anyone who has learned the basics of JavaScript!'} ></Challenge>
      </div>
    </main>
  )
}