...
export default function Back({fem}) {
    return (
        <div className="absolute top-8 text-center min-w-full">
            <div className="flex flex-row items-center w-full justify-between rounded-full pl-6 pr-6">
                ...
                <div className="flex flex-row gap-7">
                    <a target="_blank" href={fem}><SiFrontendmentor className="scale-[2] text-black cursor-pointer opacity-20 hover:opacity-100 duration-200" /></a>
